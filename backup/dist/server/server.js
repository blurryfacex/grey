...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e9a176a0ee4d145f7991";
...
eval("var config = {\n  debug: false,\n  publicPath: '//localhost:4000'\n};\n\nif (true) {\n  var localhost = 'localhost';\n  config.debug = \"development\" === 'test';\n  config.port = 4000;\n  config.classScopedName = '[name]_[local]__[hash:base64:5]';\n  config.domainName = \"http://\".concat(localhost, \":4000\");\n  config.publicPath = \"http://\".concat(localhost, \":4000\");\n  config.googleAdSense = '';\n  config.GA = '';\n  config.analysisScript = '';\n}\n\nmodule.exports = config;\n\n//# sourceURL=webpack:///./config/axios.js?");
...
eval("module.exports = __webpack_require__(/*! ./src/server/index */\"./src/server/axios.js\");\n\n\n//# sourceURL=webpack:///multi_./src/server/index?");
